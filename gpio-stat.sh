#!/bin/sh
	#clear ;
echo "\033[0m--- " `date` " ---" ;
echo "\033[0mReleu traf:" `gpio -g read 26` ;
...
echo "\033[0;31mLED rosu:" `gpio -g read 18` ;
echo "\033[0;32mLED verde:" `gpio -g read 19` ;
echo "\033[0;36mLED albastru: " `gpio -g read 13` ;
